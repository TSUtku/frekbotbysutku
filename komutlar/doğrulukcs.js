...
exports.run = async (bot, message, args) => {
    var dogruluk = ['Telefonunda arattığın en son şey nedir ?', 'Bir sabah karşı cins olarak uyansaydın ilk yapacağın şey ne olurdu ?', 'Sokakta yere bir şey düşürdüğünde hiç bir şey olmamış gibi alıp ağzına attın mı ?', 'Merve ile ilgili hiisetiğin bir kelime söyle', 'Sevidğin kızın ismi', '**BOŞ ŞANSLI ÇOÇUK**', 'Hiç Öpüştünmü', 'Hiç seviştinmi', 'Botu nasıl buldun']
    var cesaret = ['İğrenç bir ses tonuyla şarkı söyle', 'Bugün yaptığın bir şeyle alakalı uydurma kısa, komik bir hikaye anlat', 'Whatsappındaki son mesajlaşmanı bize oku', 'Çok yüksek bir sesle 3 saniye bağır', 'Durumuna MerveAkals Seviyorum yaz', 'BOŞ **ŞANSLISIN**', 'Merveye dm yaz Çıkma teklifi et', 'SUNUCUDA BİRİNE 10 SANİYELİĞİNE YETKİLİ YAP [tanımadığın biri]']
