...
exports.run = (client, message, args) => {
    ...
    .setAuthor(`${client.user.username} `, client.user.avatarURL) 
      ...
      .addField('** Eğlence (9)**',   `herkes için kullanılabilecek eğlence komutları. \n` + '`a!kralol`, `a!nahçek`, `a!öp`, `a!adamol`, `a!saat`, `a!adamasmaca`, `a!zuladesteaç`, `a!csgo-kasa-açma`, `a!şansım` , `a!hackle , `a!kapaklaflar , `a!olay` , `a!kodkullan` , `a!sigara`')
     ...
     .addField('** Moderasyon2 (13)**',`yetkililer için moderasyon komutları bölüm . \n` + '`a!bb-kanal`,`a!ayar`,`a!duyur`,`a!capslock-filtresi`,`a!partnerlik-şartları`,`a!yavaşmod`,`a!prefix`,`a!Oto-Cevap`,`a!koruma`,`a!csgo-kasa-açma`,`a!üyedurum`,`a!log-ayarla`,`a!emojiler`,`a!kaç-komut-var`')
 ...
 .addField('**SUNUCU İÇİN İDEAL(9**',   `Koruma sistemlerine kadar \n` + '`a!kanal-koruma`, `a!kanal-koruma-sıfırla`, `a!rol-koruma`,, `a!hazır-sunucu-komutları`, , `a!sunucu-koruma` , `a!ototag` ')
