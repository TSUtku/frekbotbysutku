...
exports.run = (client, message, args) => {
    ...
    .setAuthor(`${client.user.username} `, client.user.avatarURL) 
      ...
      .addField('** Komutlar (13)**', `herkesin kullanabileceği standart komutlar. \n` +  '`a!bilgi`, `a!davet`, `a!gold-üye`, `a!webpanel`, `a!sunucubilgi`, `a!kullanıcı-bilgi`, `a!balıktut`, `a!seviye`, `a!yardım`, `a!erkek`, `a!doğumgünü`, `yakında`,`a!yılbaşı`')
      .addField('** Eğlence (9)**',   `herkes için kullanılabilecek eğlence komutları. \n` + '`a!kralol`, `a!nahçek`, `a!öp`, `a!adamol`, `yakında`, `yakında`, `yakında`, `yakında`')
      ...
      .addField('** Moderasyon2 (13)**',`yetkililer için moderasyon komutları bölüm . \n` + '`a!bb-kanal`,`a!ayar`,`a!duyur`,`a!capslock-filtresi`,`a!sunucutanıt`,`a!yavaşmod`,`a!prefix`,`a!Oto-Cevap`,`a!koruma`,`a!yakında`,`a!yakında`,`a!yakında`,`a!emojiler`')
