...
exports.run = (client, message, args) => {
    ...
    .setAuthor(`${client.user.username} `, client.user.avatarURL) 
      ...
      .addField('** Komutlar (13)**', `herkesin kullanabileceği standart komutlar. \n` +  '`a!bilgi`, `a!davet`, `a!gold-üye`, `a!webpanel`, `a!sunucubilgi`, `a!kullanıcı-bilgi`, `a!balıktut`, `a!seviye`, `a!yardım`, `a!erkek`, `a!doğumgünü`, `a!günlük-kredi`,`a!yılbaşı` ,`a!bağış`')
