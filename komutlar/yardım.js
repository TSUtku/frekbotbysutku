...
exports.run = (client, message, args) => {
    ...
    .setAuthor(`${client.user.username} `, client.user.avatarURL) 
     ...
     .addField('** Moderasyon2 (13)**',`yetkililer için moderasyon komutları bölüm . \n` + '`a!bb-kanal`,`a!ayar`,`a!duyur`,`a!capslock-filtresi`,`a!sunucutanıt`,`a!yavaşmod`,`a!prefix`,`a!Oto-Cevap`,`a!koruma`,`a!csgo-kasa-açma`,`a!üyedurum`,`a!`,`a!emojiler`,`a!kaç-komut-var`')
