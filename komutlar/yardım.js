...
exports.run = (client, message, args) => {
    ...
    .setAuthor(`${client.user.username} `, client.user.avatarURL) 
     ...
     .addField('** Moderasyon2 (13)**',`yetkililer için moderasyon komutları bölüm . \n` + '`a!bb-kanal`,`a!ayar`,`a!duyur`,`a!capslock-filtresi`,`a!sunucutanıt`,`a!yavaşmod`,`a!prefix`,`a!Oto-Cevap`,`a!koruma`,`a!csgo-kasa-açma`,`a!üyedurum`,`a!everyone-engelle`,`a!emojiler`')
     .addField('** YENİLİKLER (9**',   `herkes için kullanılabilecek yenilikler komutları. \n` + '`a!premium`, `a!nahçek`, `a!öp`, `a!zuladesteaç`, `a!saat`, `a!top10`,`a!komutara`, `a!kısalt` , `a!ilginçbilgi`, `a!instagram`, `a!öneri`, `a!oylama` , `a!yakında`')
